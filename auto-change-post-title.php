<?php
    ...
    function acpt_plugin_setting_id_page() {
        ...
        ?>
            <input id="acpt_plugin_setting_id_page" name="acpt_example_plugin_options[id_page]" type="text" value="<?php echo isset($options['id_page']) ? esc_attr( $options['id_page'] ) : '1'; ?>" style="width: 18.6rem;" />
        <?php
    }
    ...
    function acpt_change_title() {
        ...
        if(!empty($paged)) {
            ...
            $message = 'Please do not leave the Update posts from page number field blank';
            update_option('acpt_error_notice', $message);
            exit();
        }
